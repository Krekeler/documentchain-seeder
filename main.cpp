...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "documentchain-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.documentchain.org",
                                       "", // "dnsseed.cpu-pool.club",
                                       "",
                                       "",
                                       ""};
static const string testnet_seeds[] = {"tdnsseed.documentchain.org",
                                       "",
                                       "",
                                       "",
                                       ""};
...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
  //db.Add(CService("kjy2eqzk4zwi5zd3.onion", 41319), true);
  }
  do {
